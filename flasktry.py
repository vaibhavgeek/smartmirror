    ...
    def do_GET(self):
        ...
        while True:
            try:
                ...
                imgarr=["shirty.png" , "shirt1.png",'shirt2.png','shirt51.jpg','shirt6.png']
        ...
        # cv2.setWindowProperty('img',cv2.WND_PROP_FULLSCREEN,cv2.cv.CV_WINDOW_FULLSCREEN)
               # cv2.resizeWindow("img", (int(width*3/2), int(height*3/2)))
                ...
                cv2.rectangle(img, (10,10) , (110,110) , (255,255,255), 2)
                cv2.rectangle(img, (900,10) , (1200,100) , (255,255,255) ,2 )
                #print(q)
                if (q % 2) == 0:
                    frame1 = img[0:100, 0:100]
                    frame1 = np.int32(frame1)
                    #cv2.imwrite("1.bmp", img[0:100, 0:100])     # save frame as JPEG file
                elif (q % 2) != 0:
                    #cv2.imwrite("2.bmp" , img[0:100, 0:100])
                    frame2 = img[0:100, 0:100]
                    frame2 = np.int32(frame2)
